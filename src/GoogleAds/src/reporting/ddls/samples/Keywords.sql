...
SELECT
  ...
  Keywords.average_cpc / 1000000 AS average_cpc,
  Criterion.quality_info.quality_score,
  Keywords.metrics.all_conversions,
  Keywords.metrics.cost_per_conversion / 1000000 AS cost_per_conversion,
  Keywords.metrics.search_impression_share,
